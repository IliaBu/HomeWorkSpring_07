...
/**
 * The type Device client authentication converter.
 */
public final class DeviceClientAuthenticationConverter implements AuthenticationConverter {
    ...
    /**
     * Instantiates a new Device client authentication converter.
     *
     * @param deviceAuthorizationEndpointUri the device authorization endpoint uri
     */
